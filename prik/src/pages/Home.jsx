...
export default function Home() {
  ...
  return (
    <div className="h-screen pt-24 w-full bg-gradient-to-t from-black to-neutral-900 text-white flex items-start justify-center px-5 -my-15 overflow-hidden no-scrollbar">
